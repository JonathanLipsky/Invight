...
public class Event implements ClusterItem {
    ...
    public Event( double longitude, double latitude, long startTime, long endTime, boolean isPublicEvent,String eventTitle, String eventDescription, String host, int popularity, int eventType) {
